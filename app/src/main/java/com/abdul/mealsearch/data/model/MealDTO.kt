...
//step6: declare all data type nullable with ?
...
//step8: create extension function which is used as mapper for domain meal model class
//convert MealDTO to Meal
fun MealDTO.toDomainMeal(): Meal {
    return Meal(
        id = this.idMeal,
        name = this.strMeal ?: "", //if we get null return empty string
        image = this.strMealThumb ?: ""
    )
}

//step10: create extension function which is used as mapper for domain meal details model class
//convert MealDTO to Meal
