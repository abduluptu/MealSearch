...
public class ViewHolderSearchListBindingImpl extends ViewHolderSearchListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.meal == variableId) {
            setMeal((com.abdul.mealsearch.domain.model.Meal) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMeal(@Nullable com.abdul.mealsearch.domain.model.Meal Meal) {
        this.mMeal = Meal;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.abdul.mealsearch.domain.model.Meal meal = mMeal;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.abdul.mealsearch.common.BindingAdaptersKt.urlToImage(this.viewHolderImage, mealImage);
