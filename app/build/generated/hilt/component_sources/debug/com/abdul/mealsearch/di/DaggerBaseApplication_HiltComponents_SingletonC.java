...
import com.abdul.mealsearch.hilt.HiltModules_ProvideMealDetailsRepositoryFactory;
import com.abdul.mealsearch.hilt.HiltModules_ProvideMealSearchApiFactory;
import com.abdul.mealsearch.hilt.HiltModules_ProvideMealSearchRepositoryFactory;
import com.abdul.mealsearch.presenation.MainActivity;
import com.abdul.mealsearch.presenation.meal_details.MealDetailsFragment;
import com.abdul.mealsearch.presenation.meal_details.MealDetailsViewModel;
import com.abdul.mealsearch.presenation.meal_details.MealDetailsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.abdul.mealsearch.presenation.meal_search.MealSearchFragment;
import com.abdul.mealsearch.presenation.meal_search.MealSearchViewModel;
import com.abdul.mealsearch.presenation.meal_search.MealSearchViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(MealDetailsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MealSearchViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.abdul.mealsearch.presenation.meal_details.MealDetailsViewModel", ((Provider) mealDetailsViewModelProvider)).put("com.abdul.mealsearch.presenation.meal_search.MealSearchViewModel", ((Provider) mealSearchViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.abdul.mealsearch.presenation.meal_details.MealDetailsViewModel 
          return (T) new MealDetailsViewModel(viewModelCImpl.getMealDetailsUseCase());

          case 1: // com.abdul.mealsearch.presenation.meal_search.MealSearchViewModel 
  ...
  private static final class SingletonCImpl extends BaseApplication_HiltComponents.SingletonC {
    ...
    private MealDetailsRepository mealDetailsRepository() {
      return HiltModules_ProvideMealDetailsRepositoryFactory.provideMealDetailsRepository(provideMealSearchApiProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.abdul.mealsearch.data.remote.MealSearchApi 
